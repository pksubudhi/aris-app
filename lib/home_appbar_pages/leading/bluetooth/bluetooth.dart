...
/*  connecting(double x, double y) {
  ...
  Widget noConnection(double x, double y) { // Ideally, no connection will not show any icon at all. Instead, only when discovered by BT will the screen show this grey icon.
    double sizeScale = Styles.screenSize(context) / 987;
    return Align(
        alignment: Alignment(x, y),
